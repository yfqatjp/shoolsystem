        ...
        <div class="row">
            <div class="col-sm-8">
                <?php 
                    ...
                    if($usertype == "Admin" || $usertype == "Salesman"|| $usertype == "TeacherManager"|| $usertype == "Receptionist") { 
                ?>
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <?php
                                ...
                                echo form_dropdown("payment_class", $payment_classes_options, set_value("payment_class", $paymentclass), "id='payment_class' class='form-control'");
                            ?>
                        </div>
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                               <input type="text" class="form-control" id="amount" name="amount" value="<?=set_value('amount', $paymentamount)?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <?php
								...
								// $array['Paypal'] = $this->lang->line('invoice_paypal');
                                // $array['Reduce'] = $this->lang->line('invoice_reduce');
                                echo form_dropdown("payment_principal", $array_principal, set_value("payment_principal", $principal), "id='payment_principal' class='form-control'");
                            ?>
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <textarea class="form-control" style="resize:none;" id="payment_note" name="payment_note"><?=set_value('payment_note', $paymentnote)?></textarea>
                        </div>
                        <span class="col-sm-4 control-label">
